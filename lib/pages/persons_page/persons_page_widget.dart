import 'package:moqred/components/message_bottom_sheet/message_bottom_sheet_widget.dart';
...
import 'persons_page_model.dart';
export 'persons_page_model.dart';

class PersonsPageWidget extends StatefulWidget {
  const PersonsPageWidget({super.key});

  static String routeName = 'persons';
  static String routePath = '/persons';
...
class _PersonsPageWidgetState extends State<PersonsPageWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PersonsModel());
  }
